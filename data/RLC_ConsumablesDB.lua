-- RLC_AchievementsConsumablesDB.lua
...
-- RedLobsterCultAchievements.lua.
--
-- Classification:
--   RLC_AchievementsConsumablesDB.food[itemID]  = true  â†’ food item (restores health)
--   RLC_AchievementsConsumablesDB.drink[itemID] = true  â†’ drink item (restores mana)
--
-- Item IDs are from the Vanilla 1.12 / Turtle WoW item database.

RLC_AchievementsConsumablesDB = RLC_AchievementsConsumablesDB or {}
RLC_AchievementsConsumablesDB.food  = {}
RLC_AchievementsConsumablesDB.drink = {}

-- ---------------------------------------------------------------------------
-- Food (health-restoring, eaten consumables)
-- ---------------------------------------------------------------------------
local food = RLC_AchievementsConsumablesDB.food
...
-- ---------------------------------------------------------------------------
local drink = RLC_AchievementsConsumablesDB.drink
